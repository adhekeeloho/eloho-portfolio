...
<div>
    <Header>
        <template #maincontent>
                <div class="relative h-screen w-full flex items-center justify-center look bg-center" >
  <div class="absolute top-0 right-0 bottom-0 left-0 bg-gray-500  opacity-75"></div>
  
  <form class="z-10 p-10">
  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    ...
    <div class="flex justify-end w-full px-3">
      <button class="shadow bg-gradient-to-r from-blue-300 via-teal-500 to-purple-400  focus:shadow-outline focus:outline-none text-white font-bold py-2 px-6 rounded" type="submit">
        Send Message
      </button>
    </div>
